 ...
 */
public class IoConnector extends MonitoredSelector implements Runnable, Closeable {

    public static final Logger LOG = Logger.getLogger(IoConnector.class.getName());
    ...
    // timeout support
    public static final long DEFAULT_WATCHDOG_PERIOD_MILLIS =  1L * 60L * 1000L;
    public long watchDogPeriodMillis = DEFAULT_WATCHDOG_PERIOD_MILLIS;
    public final TimeoutCheckTask timeoutCheckTask = new TimeoutCheckTask();
    public TimerTask watchDogTask;
    ...
    // queues
    public final ConcurrentLinkedQueue<Runnable> taskQueue = new ConcurrentLinkedQueue<Runnable>();

    public IoConnector() {
        this.name = CONNECTOR_PREFIX + "#" ;
    ...
    public int performTaskQueue() throws IOException {
    ...
    public void addToTaskQueue(Runnable task) {
        taskQueue.add(task);
        selector.wakeup();
    }
    ...
    public final class RegisterTask implements Runnable {
        ...
        public final IIoConnectorCallback callback;
        ...
        public void connect(SocketChannel channel, InetSocketAddress remoteAddress) throws IOException {
            try {
