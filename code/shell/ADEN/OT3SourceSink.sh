...
SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/MyServer.jar:$subjectloc/MyClient.jar:$subjectloc/ADEN.jar:$ROOT/FLOWDIST.jar"
...
INDIR=$subjectloc/OT3Instrumented
OUTDIR=$LOGDIR
# mkdir -p $OUTDIR -f
...
java -Xmx400g -ea -cp ${MAINCP} disttaint.dt2SourceSink \
	$OUTDIR \
	$INDIR \
	"-method" \
	"-stmt" \
