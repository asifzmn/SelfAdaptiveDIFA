...
echo $MAINCP
rm -R out-DTInstrFGHi -f
mkdir -p out-DTInstrFGHi


SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/binFGHi:/home/xqfu/FLOWDIST.jar"


echo $SOOTCP
OUTDIR=$subjectloc/DTInstrumentedFGHi
rm -R $OUTDIR
mkdir -p $OUTDIR
...
java -Xmx400g -ea -cp ${MAINCP} disttaint.dtInst \
	...
	-process-dir $subjectloc/binFGHi \
	-allowphantom \
	-dumpFunctionList \
