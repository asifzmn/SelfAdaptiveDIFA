...
echo $MAINCP
rm -R out-DTInstrOQ -f
mkdir -p out-DTInstrOQ


SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/binOQ:/home/xqfu/FLOWDIST.jar"


echo $SOOTCP
OUTDIR=$subjectloc/DTInstrumentedOQ
rm -R $OUTDIR
mkdir -p $OUTDIR
