...
echo $MAINCP
rm -R out-DTInstrRr -f
mkdir -p out-DTInstrRr


SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/binRr:/home/xqfu/FLOWDIST.jar"


echo $SOOTCP
OUTDIR=$subjectloc/DTInstrumentedRr
rm -R $OUTDIR
mkdir -p $OUTDIR
