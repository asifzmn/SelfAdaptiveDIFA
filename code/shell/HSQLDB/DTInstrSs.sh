...
echo $MAINCP
rm -R out-DTInstrSs -f
mkdir -p out-DTInstrSs


SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/binSs:/home/xqfu/FLOWDIST.jar"


echo $SOOTCP
OUTDIR=$subjectloc/DTInstrumentedSs
rm -R $OUTDIR
mkdir -p $OUTDIR
