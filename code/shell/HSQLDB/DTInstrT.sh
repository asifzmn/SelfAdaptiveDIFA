...
echo $MAINCP
rm -R out-DTInstrT -f
mkdir -p out-DTInstrT


SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/binT:/home/xqfu/FLOWDIST.jar"


echo $SOOTCP
OUTDIR=$subjectloc/DTInstrumentedTt
rm -R $OUTDIR
mkdir -p $OUTDIR
