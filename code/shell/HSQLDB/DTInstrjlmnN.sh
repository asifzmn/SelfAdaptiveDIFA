...
echo $MAINCP
rm -R out-DTInstrjlmnN -f
mkdir -p out-DTInstrjlmnN


SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/binjlmnN:/home/xqfu/FLOWDIST.jar"


echo $SOOTCP
OUTDIR=$subjectloc/DTInstrumentedjlmnN
rm -R $OUTDIR
mkdir -p $OUTDIR
...
java -Xmx400g -ea -cp ${MAINCP} disttaint.dtInst \
	...
	-process-dir $subjectloc/binjlmnN \
	-allowphantom \
	-dumpFunctionList \
