...
echo $MAINCP
rm -R out-DTInstruV -f
mkdir -p out-DTInstruV


SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/binuV:/home/xqfu/FLOWDIST.jar"


echo $SOOTCP
OUTDIR=$subjectloc/DTInstrumenteduV
rm -R $OUTDIR
mkdir -p $OUTDIR
