...
MAINCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$ROOT/libs/DUA1.jar:$ROOT/libs/distEADIVER.jar::$ROOT/libs/soot-trunk.jar:$subjectloc/DiverInstrumented"
