...
#MAINCP=".:/opt/jdk1.8.0_101/jre/lib/rt.jar:/home/xqfu/libs/soot-trunk.jar:/home/xqfu/libs/DUA1.jar:/home/xqfu/libs/mcia8.jar:$/home/xqfu/netty/bin"
...
#SOOTCP=".:/opt/jdk1.8.0_101/jre/lib/rt.jar:/home/xqfu/netty/bin:/home/xqfu/libs/soot-trunk.jar:/home/xqfu/libs/DUA1.jar:/home/xqfu/libs/mcia8.jar"

SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/4119:$subjectloc/java:$ROOT/FLOWDIST.jar"


echo $SOOTCP
OUTDIR=/home/xqfu/netty/OTInstrumented
rm -R $OUTDIR
mkdir -p $OUTDIR
...
java -Xmx400g -ea -cp ${MAINCP} disttaint.OTInstr \
	-w -cp ${SOOTCP} \
