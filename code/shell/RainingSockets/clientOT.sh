...
MAINCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:/home/xqfu/RainSockets/lib/concurrent.jar:$ROOT/DUA1.jar:$ROOT/FLOWDIST.jar:$ROOT/libs/soot-trunk.jar:$subjectloc/OTInstrumented"

suffix=""

MAINCLS="raining.examples.PipelinedClient"
