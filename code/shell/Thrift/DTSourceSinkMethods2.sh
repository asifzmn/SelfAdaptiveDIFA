...
source ./th_global.sh
MAINCP="/home/xqfu/DUA7.jar:$ROOT/FlowDist.jar:$ROOT/libs/soot-trunk.jar"

SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/jar:$ROOT/FlowDist.jar"
