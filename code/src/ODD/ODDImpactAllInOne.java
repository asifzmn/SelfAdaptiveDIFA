...
public class ODDImpactAllInOne {
	...
	protected static Map<VTEType, List<SVTEdge>> type2edges;
	...
	protected Map< Integer, Map<VTEType, Set<SVTNode>> > ImpOPs;
	...
	protected void initInternals() {
		...
		ImpOPs = new LinkedHashMap<Integer, Map<VTEType, Set<SVTNode>>>();
	}
	...
	public void add2ImpOPs(int midx, VTEType et, SVTNode node) {
		if (allQueries!=null && !allQueries.contains(midx)) {
			return;
		}
		Map<VTEType, Set<SVTNode>> ty2imnodes = ImpOPs.get(midx);
		if (ty2imnodes == null) {
			ty2imnodes = new LinkedHashMap<VTEType, Set<SVTNode>>();
