...
public class Agent {
	...
	public double[][][] Qtable = new double[Variant.Framework_height][Variant.Framework_width][Action
			.values().length];

	public int[][][] actions = new int[Variant.Framework_height][Variant.Framework_width][Action
			.values().length];

	public double[][][] rewards = new double[Variant.Framework_height][Variant.Framework_width][Action
			.values().length];
