...
public class OTBetterSourceSink {
...
//		System.out.println("sinkMsg="+sinkMsg);
		...
		System.out.println("coveredSourceMethods().size()=" + coveredSourceMethods.size()+" coveredSourceMethods()=" + coveredSourceMethods);
		System.out.println("coveredSinkMethods().size()=" + coveredSinkMethods.size()+" coveredSinkMethods()=" + coveredSinkMethods);
