...
//		String sinkMsg="";
		...
		String sourceMethodFile=System.getProperty("user.dir") + File.separator + "sourceAllMethod.txt";
		String sinkMethodFile=System.getProperty("user.dir") + File.separator + "sinkAllMethod.txt"; 
		String sourceStmtFile=System.getProperty("user.dir") + File.separator + "sourceAllStmt.txt";
		String sinkStmtFile=System.getProperty("user.dir") + File.separator + "sinkAllStmt.txt"; 
...
//			useSinkInterfaceFirstStmt=false;
				...
				while(stmts.hasNext())
				{
					...
					if (sourceClassHierarchy.length()>0)
					{
						...
						if (methodItem.length()>1)  
						{
							...
							sourceMethodMsg+=methodSource2+"\n";
							sourceStmtMsg+=methodSource2 +" - "+midStr1+"\n";
					...
					if (sinkClassHierarchy.length()>0)
					{
						...
						if (methodItem.length()>1)  
						{
							...
							sinkMethodMsg+=methodSink2+"\n";
							sinkStmtMsg+=methodSink2 +" - "+midStr1+"\n";							
		...
		System.out.println("sourceMethodFile="+sourceMethodFile);
		System.out.println("sourceMethodMsg="+sourceMethodMsg);
		dtConfig.writeMessage(sourceMethodFile, sourceMethodMsg);
		System.out.println("sinkMethodFile="+sinkMethodFile);
		System.out.println("sinkMethodMsg="+sinkMethodMsg);
		dtConfig.writeMessage(sinkMethodFile, sinkMethodMsg);


		System.out.println("sourceStmtFile="+sourceStmtFile);
		System.out.println("sourceStmtMsg="+sourceStmtMsg);
		dtConfig.writeMessage(sourceStmtFile, sourceStmtMsg);
		System.out.println("sinkStmtFile="+sinkStmtFile);
		System.out.println("sinkStmtMsg="+sinkStmtMsg);
		dtConfig.writeMessage(sinkStmtFile, sinkStmtMsg);
